 ...
 */
class JsonFormatModule : ModuleExtension {
    ...
    override val options = listOf(
        ...
        ModuleOption("path", OptionType.TEXT, ""),
        ModuleOption("indent", OptionType.SELECT, "2", listOf("2", "4", "tab")),
        // sorting makes two documents comparable; off by default, since order can carry meaning
        ModuleOption("sortKeys", OptionType.SELECT, "false", listOf("false", "true")),
    )
