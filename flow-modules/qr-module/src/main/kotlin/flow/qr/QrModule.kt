 ...
 */
class QrModule : ModuleExtension {
    ...
    override val options = listOf(
        ...
        ModuleOption("correction", OptionType.SELECT, "L", listOf("L", "M", "Q", "H")),
        ModuleOption("moduleSize", OptionType.NUMBER, "8"),
        ...
        ModuleOption("quietZone", OptionType.NUMBER, "4"),
    )
