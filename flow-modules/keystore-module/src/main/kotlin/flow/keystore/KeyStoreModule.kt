 ...
 */
class KeyStoreModule : ModuleExtension {
    ...
    override val options = listOf(
        ModuleOption("type", OptionType.SELECT, "PKCS12", listOf("PKCS12", "JKS")),
        ModuleOption("alias", OptionType.TEXT, ""),
        ModuleOption("keyPassword", OptionType.TEXT, ""),
    )
