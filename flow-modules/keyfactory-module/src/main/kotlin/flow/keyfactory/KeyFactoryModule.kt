 ...
 */
class KeyFactoryModule : ModuleExtension {
    ...
    override val options = listOf(
        ...
        ModuleOption("keyType", OptionType.SELECT, "private", listOf("private", "public")),
        // PBKDF2 only
        ModuleOption("iterations", OptionType.NUMBER, "65536"),
        ModuleOption("keySize", OptionType.NUMBER, "256"),
    )
