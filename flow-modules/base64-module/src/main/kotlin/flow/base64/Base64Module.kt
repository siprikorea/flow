...
/**
 * Base64 module module. The "mode" option selects encoding or decoding, "variant" picks the
 ...
 * encoding.
 */
class Base64Module : ModuleExtension {
    ...
    override val options = listOf(
        ModuleOption("mode", OptionType.SELECT, "encode", listOf("encode", "decode")),
        ModuleOption("variant", OptionType.SELECT, "standard", listOf("standard", "url")),
        ModuleOption("padding", OptionType.SELECT, "true", listOf("true", "false")),
    )
