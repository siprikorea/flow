 ...
 */
class McpToolModule : ModuleExtension {
    ...
    override val options = listOf(
        ...
        ModuleOption("command", OptionType.TEXT, ""),
        ModuleOption("tool", OptionType.TEXT, ""),
        ModuleOption("argument", OptionType.TEXT, "input"),
        // extra arguments as a JSON object, e.g. {"format":"json"}
        ModuleOption("arguments", OptionType.TEXT, ""),
