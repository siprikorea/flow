 ...
 * the module contract, the Kotlin runtime and the module itself — anything else on it would
 * be another thing an module could collide with, which is the point of running it out of
