...
/**
 * A failure that happened inside an extension, with the kind of failure it was.
 *
 * An extension runs in another process, so what comes back is text — and text is not enough to
 ...
 */
class ExtensionFailure(message: String, val type: String) : RuntimeException(message)
