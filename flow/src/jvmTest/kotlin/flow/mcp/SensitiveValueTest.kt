...
class SensitiveValueTest {
    ...
    fun `the modules that take a key or a password name those ports as sensitive`() {
        ...
        // Nothing installed is not a failure: these read the module store on the machine the
    ...
    /** True when this machine has no modules installed at all, so there was nothing to check. */
