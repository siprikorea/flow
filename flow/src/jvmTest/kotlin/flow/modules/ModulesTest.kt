...
/**
 * What each shipped module actually computes.
 *
 * Published vectors where there are any — a digest, an HMAC — because an module that computes
 ...
 *
 * Modules are reached through the service loader rather than by constructing them, so this also
...
class ModuleExtensionsTest {
    ...
    private fun ext(id: String): ModuleExtension =
