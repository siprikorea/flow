...
kotlin {
    ...
    sourceSets {
        ...
        jvmTest.dependencies {
            ...
            implementation(project(":flow-modules:cert-module"))
            implementation(project(":flow-modules:pkcs7-module"))
            implementation(project(":flow-modules:pkcs12-module"))
            implementation(project(":flow-modules:csr-module"))
            implementation(project(":flow-modules:crl-module"))
            implementation(project(":flow-modules:certpath-module"))
            implementation(project(":flow-modules:ca-module"))
