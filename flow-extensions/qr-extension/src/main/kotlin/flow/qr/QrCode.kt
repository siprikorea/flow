 ...
 *
 * Written out here rather than pulled in so the extension stays a single jar with nothing to
 * collide with — the same rule the other shipped extensions follow. Byte mode only, which is what
