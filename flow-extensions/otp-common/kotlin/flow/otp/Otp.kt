 ...
 * derived from the clock, so [TotpExtension] works out that counter and hands it here.
 */
internal object Otp {
    ...
    fun options() = listOf(
        ExtensionOption("algorithm", OptionType.SELECT, "HmacSHA1", ALGORITHMS),
        ExtensionOption("digits", OptionType.SELECT, "6", DIGITS),
    )
